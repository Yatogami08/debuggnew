import 'package:testthune/dailoz/dailoz_gloabelclass/dailoz_color.dart';
import 'package:testthune/dailoz/dailoz_gloabelclass/dailoz_fontstyle.dart';
import 'package:testthune/dailoz/dailoz_gloabelclass/dailoz_icons.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:flutter_svg/svg.dart';

import '../dailoz_home/dailoz_dashboard.dart';
import 'dailoz_forgotpassword.dart';

class DailozLogin extends StatefulWidget {
  const DailozLogin({Key? key}) : super(key: key);

  @override
  State<DailozLogin> createState() => _DailozLoginState();
}

class _DailozLoginState extends State<DailozLogin> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
