                              ...
                              children: [
                                Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text("Urgent",style: hsMedium.copyWith(fontSize: 10,color: DailozColor.textblue),),
                                    )),
                                ...
                                Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(horizontal: width/36,vertical: height/120),
                                      child: Text("Home",style: hsMedium.copyWith(fontSize: 10,color: DailozColor.textblue),),
                                    )),
                              ],
                            ),
                          ],
